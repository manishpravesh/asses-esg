      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 flex-col justify-between p-12">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <span className="text-white font-bold text-lg tracking-tight">
            ESG <span className="text-emerald-400">Portal</span>
          </span>
        </div>
        ...
        <div className="relative space-y-8">
          <div>
            ...
            <p className="mt-4 text-slate-400 text-sm leading-relaxed max-w-xs">
              The analyst portal for reviewing, validating, and locking ESG
              activity data before it goes to audit.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            {[
              {
                icon: "⚡",
                label: "Automated ingestion from SAP, utilities & travel",
              },
        ...
        <div className="relative">
          <p className="text-xs text-slate-600">
            © {new Date().getFullYear()} ESG Portal. All rights reserved.
          </p>
        </div>
      </div>
